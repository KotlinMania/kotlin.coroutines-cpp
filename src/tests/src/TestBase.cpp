...
public
 actual val isStressTest: Boolean
=
false
public
 actual val stressTestMultiplier: Int
=
1
public
 actual val stressTestMultiplierSqrt: Int
=
1
...
actual constructor() : OrderedExecutionTestBase(), ErrorCatching
by ErrorCatching
.
Impl() {
    actual fun println(message
    :
    Any ?
    )
    {
            ...
            runBlocking(block = block, context = CoroutineExceptionHandler{
                ...
                if (e is CancellationException) return@ CoroutineExceptionHandler // are ignored
                                           ...
                                           when{
                                               ...
                                               error(
                                                   "Too many unhandled exceptions $exCount, expected ${unhandled.size}, got: $e",
                                                   e)
...
public
 actual val isJavaAndWindows: Boolean

get() =

false

actual val usesSharedEventLoop: Boolean
=
false