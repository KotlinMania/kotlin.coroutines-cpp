...
namespace kotlinx {
    namespace coroutines {
        namespace channels {
            ...
            private:
                /* suspend */
                void testReceiveCatching(/* kind: TestChannelKind */) /* = coroutineScope */ {
                    reset();
                    // TODO: auto channel = kind.create<int>();
                    // TODO: launch([&]() {
                    //     expect(2);
                ...
                /* suspend */
                void testTrySendAfterClose(/* kind: TestChannelKind */) /* = coroutineScope */ {
                    // TODO: auto channel = kind.create<int>();
                ...
                /* suspend */
                void testTrySendToFullChannel(/* kind: TestChannelKind */) /* = coroutineScope */ {
     ...
     */
                /* suspend */
                void testSendAfterClose(/* kind: TestChannelKind */) {
                ...
                /* suspend */
                void testSendReceive(/* kind: TestChannelKind, */ int iterations) /* = coroutineScope */ {
                    // TODO: auto channel = kind.create<int>();
                    // TODO: launch([&]() {
