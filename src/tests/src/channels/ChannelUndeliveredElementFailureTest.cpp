 ...
 */
            ...
            public:
                ...
                // TODO: @Test
                void testFailedHandlerInClosedConflatedChannel()
                /* = runTest(expected = { it is UndeliveredElementException }) */ {
                    // TODO: Implementation
                }

                // TODO: @Test
                void testFailedHandlerInClosedBufferedChannel()
                /* = runTest(expected = { it is UndeliveredElementException }) */ {
                    // TODO: Implementation
                }

                // TODO: @Test
                void testSendDropOldestInvokeHandlerBuffered()
                /* = runTest(expected = { it is UndeliveredElementException }) */ {
                    // TODO: Implementation
                }

                // TODO: @Test
                void testSendDropLatestInvokeHandlerBuffered()
                /* = runTest(expected = { it is UndeliveredElementException }) */ {
                    // TODO: Implementation
                }

                // TODO: @Test
                void testSendDropOldestInvokeHandlerConflated()
                /* = runTest(expected = { it is UndeliveredElementException }) */ {
                    // TODO: Implementation
                }
            };
