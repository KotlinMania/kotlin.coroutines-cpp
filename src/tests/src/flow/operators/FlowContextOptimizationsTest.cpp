            ...
            public:
                ...
                void test_baseline() /* TODO: = runTest */ {
                    ...
                    flow([]() /* TODO: suspend */ {
                            ...
                            .collect([&](int value) {
                                assert_equals(collect_context.minus_key(Job::key),
                                              current_context().minus_key(Job::key));
                                if (value == 1) expect(4);
                                else expect(5);
                            });
                ...
                struct CustomContextElement : public AbstractCoroutineContextElement {
                    ...
                    CustomContextElement(const std::string &str_) : AbstractCoroutineContextElement(Key), str(str_) {
                    }
