...
public:
    ...
    // TODO: @Test
    void testUncaughtExceptionsInProduce() /* = runTest(unhandled = {[](auto it) { return it is TestException; }}) */ {
        // TODO: Implementation
    }
...
private:
    /* suspend */ void cancelOnCompletion(/* CoroutineContext coroutineContext */) /* = CoroutineScope(coroutineContext).apply */ {
        // TODO: Implementation
    }
};
