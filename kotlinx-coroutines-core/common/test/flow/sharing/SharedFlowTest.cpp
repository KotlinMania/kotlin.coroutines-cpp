    ...
    void test_rendezvous_shared_flow_basic() {
        ...
        run_test([this]() {
            ...
            auto job1 = launch(CoroutineStart::kUndispatched, [&]() {
                ...
                sh.collect([&](int* it) {
                    switch(*it) {
                        case 4: expect(5); break;
                        case 6: expect(7); break;
                        case 10: expect(11); break;
                        case 13: expect(14); break;
            ...
            auto job2 = launch(CoroutineStart::kUndispatched, [&]() {
                ...
                sh.collect([&](int* it) {
                    if (it == nullptr) {
                        ...
                        switch(*it) {
                            case 10: expect(12); break;
                            case 13: expect(15); break;
                            case 17: expect(18); break;
                            case 21: expect(22); break;
                            default: expect_unreached();
                        }
                    }
                });
