...
public:
    ...
    void test_empty_flow() /* TODO: = runTest */ {
        assert_null(empty_flow<int>().transform_latest([](int) /* TODO: suspend */ { emit(1); }).single_or_null());
    }
    ...
    void test_isolated_context() /* TODO: = runTest */ {
        auto flow = flow([]() /* TODO: suspend */ {
            ...
            emit(5);
            expect(3);
        }).flow_on(NamedDispatchers("source")).transform_latest<int, int>([](int value) /* TODO: suspend */ {
