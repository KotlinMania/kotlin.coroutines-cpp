...
// Original: ui/kotlinx-coroutines-javafx/test/guide/example-ui-basic-03.kt
...
void setup(Text* hello, Circle* fab) {
    auto job = GlobalScope::launch(Dispatchers::Main, [hello]() { // launch coroutine in the main thread
    ...
    fab->set_on_mouse_clicked(EventHandler([job](auto event) {
