...
// Original: ui/kotlinx-coroutines-javafx/test/guide/example-ui-basic-02.kt
...
void setup(Text* hello, Circle* fab) {
    GlobalScope::launch(Dispatchers::Main, [hello]() { // launch coroutine in the main thread
