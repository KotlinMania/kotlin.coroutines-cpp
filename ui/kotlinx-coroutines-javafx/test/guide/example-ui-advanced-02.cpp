...
// Original: ui/kotlinx-coroutines-javafx/test/guide/example-ui-advanced-02.kt
...
// TODO: Implement CoroutineStart::UNDISPATCHED

namespace kotlinx {
namespace coroutines {
namespace javafx {
namespace guide {
namespace example_ui_advanced_02 {
...
void setup(Text* hello, Circle* fab) {
    fab->set_on_mouse_clicked(EventHandler([](auto event) {
        ...
        GlobalScope::launch(Dispatchers::Main, CoroutineStart::kUndispatched, []() { // <--- Notice this change
