...
// Original: ui/kotlinx-coroutines-javafx/test/guide/example-ui-actor-03.kt
...
// TODO: Implement actor pattern with conflation

namespace kotlinx {
namespace coroutines {
namespace javafx {
namespace guide {
namespace example_ui_actor_03 {
...
void on_click(Node* node, std::function<void(MouseEvent*)> action) {
    ...
    auto event_actor = GlobalScope::actor<MouseEvent*>(Dispatchers::Main, Channel::kConflated, [action](auto channel) { // <--- Changed here
